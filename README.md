...
```
pip install git+https://github.com/StefanNa3Shape/whisper-jax.git
```

To update the Whisper JAX package to the latest version, simply run:
```
pip install --upgrade --no-deps --force-reinstall git+https://github.com/StefanNa3Shape/whisper-jax.git
```
